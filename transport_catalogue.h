...
public:
    ...
    using DistancesBetweenStops = std::unordered_map<StopPair, int, StopPairHasher>;
    ...
    const DistancesBetweenStops& GetDistances() const;
...
private:   
    ...
    DistancesBetweenStops distances_;
